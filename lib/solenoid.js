...
module.exports.fetch = function fetch(options, callback) {
  ...
  function doFetch(callback) {
    ...
    client.download({
      ...
      .pipe(fs.createWriteStream(packedSnapshotPath))
...
module.exports.readPackageJSON = function readPackageJSON(options, callback) {
...
module.exports.start = function start(options, callback) {
  var args = [],
      child;
